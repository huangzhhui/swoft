 ...
 */
class ServerRequest extends Psr7Request implements ServerRequestInterface
{
     ...
     */
    public static function getUriFromGlobals(\Swoole\Http\Request $swooleRequest)
    {
        $server = $swooleRequest->server;
        $uri = new Uri('');
